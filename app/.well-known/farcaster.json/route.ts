...
const FALLBACK_APP_URL = 'https://tobyhop.vercel.app';
  ...
  return NextResponse.json(
    {
      ...
      miniapp: {
        ...
        /*
          Farcaster posts miniapp_added, miniapp_removed,
        ...
        */
        ...
        description:
          'Tap Toby each day, collect Big Pond Energy, build a streak, and climb the leaderboard.',
